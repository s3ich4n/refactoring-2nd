...
def test_one_joker():
    ...
    with patch("chapter10.src.case07.case_07_1.send_alert") as mock_alert:
        alert_for_villains(["batman", "joker", "superman"])
...
def test_one_saruman():
    ...
    with patch("chapter10.src.case07.case_07_1.send_alert") as mock_alert:
        alert_for_villains(["batman", "saruman", "superman"])
        assert mock_alert.call_count == 1
...
def test_both_villains():
    ...
    with patch("chapter10.src.case07.case_07_1.send_alert") as mock_alert:
        alert_for_villains(["batman", "joker", "saruman", "superman"])
        assert mock_alert.call_count == 1
...
def test_joker_appears_twice():
    ...
    with patch("chapter10.src.case07.case_07_1.send_alert") as mock_alert:
        alert_for_villains(["batman", "joker", "superman", "joker"])
        assert mock_alert.call_count == 1
...
def test_saruman_first():
    ...
    with patch("chapter10.src.case07.case_07_1.send_alert") as mock_alert:
        alert_for_villains(["batman", "saruman", "joker", "superman"])
        assert mock_alert.call_count == 1
